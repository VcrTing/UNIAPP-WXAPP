<template>
	...
	<PageLayout>
		<UserCenterLayout :h="61.8" :clazz_con="''">
			<template #bg>
...
import VwUserCenterPan from '@/wave_backend/user/center/VwUserCenterPan.vue';
import VwUserCenterTop from '@/wave_backend/user/center/VwUserCenterTop.vue';
