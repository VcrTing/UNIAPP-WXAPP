...
export interface ApiAppInfoAppInfo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contacts: Schema.Attribute.Component<'dics.contact', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductContentProductContent
  ...
  attributes: {
    ...
    galleries: Schema.Attribute.Component<'swiper.gallery', true>;
...
export interface ApiProductMediaProductMedia
  ...
  attributes: {
    ...
    urlSmall: Schema.Attribute.Text;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    contentStatus: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dataStatus: Schema.Attribute.Integer;
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    handsome: Schema.Attribute.Integer;
    indexLevel: Schema.Attribute.Integer;
    isMain: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiUserLoveUserLove extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    love: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    loveId: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whoId: Schema.Attribute.Text;
  };
}
...
export interface ApiUserStatisticUserStatistic
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    numBuy: Schema.Attribute.Integer;
    numBuyMoneyPay: Schema.Attribute.Decimal;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    product_medias: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-media.product-media'
    >;
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    smallAppAuthCode: Schema.Attribute.Text;
    smallAppAvatar: Schema.Attribute.Text;
    smallAppOpenId: Schema.Attribute.Text;
    socialAccount: Schema.Attribute.Text;
    unionid: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
