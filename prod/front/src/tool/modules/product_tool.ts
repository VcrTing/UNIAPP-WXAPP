import { DATA_ACTIVITY_STATUS, DATA_ACTIVITY_TYPED_SM, DATA_PRODUCT_TYPED, DATA_PRODUCT_TYPED_FREE, DATA_PUBLISH_LIMIT } from "@/conf/conf-datas"
...
import { DEV_PRODUCT } from "@/conf/conf-dev"
    ...
    const is_alone = (v: Product): boolean => {
