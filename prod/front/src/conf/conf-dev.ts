import { DATA_PRODUCT_TYPED_FREE, DATA_PRODUCT_TYPED_INV_ALONE, DATA_PRODUCT_TYPED_INV_INFINI, DATA_PRODUCT_TYPED_INV_MANY, DATA_PRODUCT_TYPED_SM } from "./conf-datas"
...
export const DEV_PRODUCT = {
    INV_TYPED: {
        ALONE: DATA_PRODUCT_TYPED_INV_ALONE.v,
        MANY: DATA_PRODUCT_TYPED_INV_MANY.v,
        INFINI: DATA_PRODUCT_TYPED_INV_INFINI.v
    },
    TYPED: {
        FREE: DATA_PRODUCT_TYPED_FREE.v,
        SM: DATA_PRODUCT_TYPED_SM.v,
    },
    //
    SORT: {
        // 首页数据的排序状况
