...
export interface ApiActivityAddressActivityAddress
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isDefault: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiActivityTagActivityTag extends Struct.CollectionTypeSchema {
...
export interface ApiActivityActivity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    endJoinTime: Schema.Attribute.DateTime;
