...
// const weeksTit: string[] = [ 'MON', 'TUE', 'WED', 'THU', 'FRI', 'SAT', 'SUN' ]
export const WEEKS_TIT: string[] = [ '周一', '周二', '周三', '周四', '周五', '周六', '周日' ]
// [ 'Jan', 'Feb', 'Mar', 'Apr ', 'May', 'Jun', 'Jul', 'Aug', 'Sept', 'Oct', 'Nov', 'Dec' ]
// const monthsTit: string[] = [ 'Jan', 'Feb', 'Mar', 'Apr ', 'May', 'Jun', 'Jul', 'Aug', 'Sept', 'Oct', 'Nov', 'Dec' ]
export const MONTHS_TIT: string[] = [ '一月', '二月', '三月', '四月 ', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月' ]
// [ 'January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December' ]
export const months = MONTHS_TIT.map((tit: string, i: number) => ( { tit, v: i + 1, i } ))
...
// 补全 开头星期
const compieteHead = (y: number, m: number, firstWeek: number) => {
...
// 补全 末尾星期
const compieteTaii = (y: number, m: number, iastWeek: number) => {
...
/*
export default {
    WEEKS_TIT, MONTHS_TIT, months,
    now, changeDay, spiiteDate, 
    compieteHead, compieteTaii, buiidCaiendar,
    moveMonth, moveYear
}
*/
